...
public class UserRegistrationMain {
	...
	public UserResgistrationInterface firstNameValidate = new UserResgistrationInterface() {
	...
	public UserResgistrationInterface lastNameValidate = new UserResgistrationInterface() {
	...
	public UserResgistrationInterface emailValidate = new UserResgistrationInterface() {
	...
	public UserResgistrationInterface phoneNumberValidate = new UserResgistrationInterface() {
	...
	public UserResgistrationInterface passwordValidate = new UserResgistrationInterface() {
